...
이렇게 만든 Next.js 앱을 Deploy 하기 위해 처음으로 `Vercel`을 사용해보았습니다. github에 push를 하면 자동으로 인식하고, Promote to Production 버튼을 누르기만 하면 몇분만에 실제 빌드까지 해주는 것이 굉장히 간편했습니다. 앞으로는 Next.js 뿐만 아니라 React 앱을 업로드 할 때도 Vercel을 사용할 것 같습니다.
