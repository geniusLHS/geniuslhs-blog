...
export default function Pre({ children, ...props }: PreProps) {
  ...
  return (
    ...
    //   <button aria-label="Copy code" type="button" className="round-btn copy-btn" onClick={onCopy}>
    //     {copied ? <CheckIcon width="16px" style={{ color: '#ccc' }} /> : <ClipboardIcon width="16px" style={{ color: '#ccc' }} />}
    //   </button>
